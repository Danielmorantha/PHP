	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Ubah Akun Admin</div>
				<?php
				...
				<br />
				<div class = "col-md-4">	
					<form method = "POST" action = "akun_ubah_akundb.php?admin_id=<?php echo $fetch['admin_id']?>">
						<div class = "form-group">
							<label>Nama </label>
							<input type = "text" class = "form-control" value = "<?php echo $fetch['nama']?>" name = "nama" />
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input type = "password" class = "form-control" value = "<?php echo $fetch['kata_sandi']?>" name = "kata_sandi" />
						</div>
						<br />
						<div class = "form-group">
